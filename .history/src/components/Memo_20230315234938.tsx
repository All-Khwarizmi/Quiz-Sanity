...
const Memo = ({ data, params }: MemoProps) => {
  ...
  return (
    <>
      ...
      <div className=' grid-col-1 py-10 lg:pt-20  grid md:grid lg:grid-cols-3 gap-x-10 gap-3 px-10'>
        {data.map((memos) =>
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    }  m-0 border-gray-300 w-96 flex flex-col items-center rounded-lg`}
                  >
                    <Image
                      priority
                      width={300}
