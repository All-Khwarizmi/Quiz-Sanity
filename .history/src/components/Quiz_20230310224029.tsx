...
const Quiz = (quiz: QuizType) => {
  ...
  const [count, setPuntos] = useState<number>();
  useEffect(() => {
  ...
  const answerBHandler = (e: any, correctAnswer: string) => {
    let answer = e.target.firstChild.data;
    if (answer === correctAnswer) {
      setIsGood(true);
  ...
  const answerCHandler = (e: any, correctAnswer: string) => {
    let answer = e.target.firstChild.data;
    if (answer === correctAnswer) {
      setIsGood(true);
  ...
  const answerDHandler = (e: any, correctAnswer: string) => {
    let answer = e.target.firstChild.data;
    if (answer === correctAnswer) {
      setIsGood(true);
