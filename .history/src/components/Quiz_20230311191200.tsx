        ...
        {quizRef.current.questions.map((question, index) => {
          return (
            ...
            >
              ...
              <div className='font-bold min-w-4/5 px-5 text-center text-3xl border-2 text-white uppercase btn rounded-lg py-10 '>
                <p>{question.question}</p>
              </div>

              {/*  reponses */}
              <div className='grid px-2 min-w-4/5 gap-5 grid-cols-2 opacity-100'>
                <div
