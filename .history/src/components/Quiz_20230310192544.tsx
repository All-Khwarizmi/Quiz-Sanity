...
export const answerAHandler = (e: any, correctAnswer: string) => {
         ...
         {quizRef.current.questions.map((question, index) => {
            ...
            return (
              ...
              >
                ...
                {/*  reponses */}
                <div onClick={(e) => answerAHandler(e, question.answerCorrect)} className='grid gap-5 grid-cols-2 opacity-100'>
                  <div
                    className={clsx(
