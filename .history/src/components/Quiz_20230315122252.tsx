...
const Quiz = (quiz: QuizType) => {
  ...
  // Memoizing getting memoDate to only when is last question to avoid to rerender and fetching from local storage. Not only no need for fresh data but it might return null 
