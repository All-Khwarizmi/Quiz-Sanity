...
const Memo = ({ data, params }: MemoProps) => {
  ...
  return (
    <>
      ...
      <div className=' grid-col-1 py-10 lg:pt-20 lg:space-y-5 grid lg:flex lg:flex-row gap-x-10 gap-3 px-10'>
        {data.map((memos) =>
                ...
                >
                  <div className=' '>
                    {!isTime.isMemoDate || isTime.memoDate?.isMemotime ? (
                      ...
                      <div className='flex flex-row space-x-32 text-sm  justify-between'>
