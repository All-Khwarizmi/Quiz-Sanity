              ...
              >
                ...
                <div className='grid gap-5 grid-cols-2 opacity-100'>
                  <div
                    ...
                    className={clsx(
                      `font-bold text-center w-full text-xl hover:border-sky-500 ${themeA} ${themeA === ""? : null} hover:scale-125 hover:text-sky-500 uppercase border-2 rounded-lg py-5 px-3`
                    )}
                  >
                    {question.answerA}
                  </div>
