            ...
            return (
              <div key={Math.floor(Math.random() * 1000)} className='min-h-96 w-96 py-5 bg-gray-900 flex flex-col rounded-lg items-center justify-center space-y-10 opacity-80'>
                ...
                <div className='grid gap-5 grid-cols-2 opacity-100'>
                  <div
                    className={clsx(
                      `font-bold text-center  text-xl hover:border-sky-500  hover:scale-125 hover:text-sky-500 uppercase border-2 rounded-lg py-5 px-3`
                    )}
                  >
                    {question.answerA}
                  </div>
                  <div className='font-bold text-center  text-xl hover:border-sky-500  hover:scale-125 hover:text-sky-500 uppercase border-2 rounded-lg py-5 px-3'>
                    {question.answerB}
                  </div>
                  <div className='font-bold text-center  text-xl hover:border-sky-500 disabled  hover:scale-125 hover:text-sky-500 uppercase border-2 rounded-lg py-5 px-3'>
                    {question.answerC}
                  </div>
                  <div className='font-bold text-center  text-xl hover:border-sky-500  hover:scale-125 hover:text-sky-500 uppercase border-2 rounded-lg py-5 px-3'>
                    {question.answerD}
