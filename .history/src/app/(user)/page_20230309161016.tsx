...
export default async function Home() {
  return (
    <>
      <main className='w-screen h-screen flex flex-row items-center  '>
        <Image
        ...
        <Link
          href={'/grid'}
          className='text-white top-20 left-20 font-bold py-2 px-3 rounded-lg text-xl bg-purple-800 relative '
        >
          ENTER
        </Link>
      </main>
